...
const float ozone_number_density     = 2.5e14;
...
const float atmosphere_mieg = 0.85;
const vec3 lambda = vec3(700.0, 550.0, 440.0) * 1e-9; //The wavelengths of visible light in nanometers.
...
const vec3 coefficient_mie = vec3(6.6e-6);
